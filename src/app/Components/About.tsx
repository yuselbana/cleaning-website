...
const About = ({portfolio,setPortfolio} : {portfolio:boolean, setPortfolio:React.Dispatch<SetStateAction<boolean>>}) => {
   ...
   <>
    ...
    <div className="flex items-center justify-center gap-4"><span>(01)</span> <p className="text-xl lg:text-2xl">about</p></div>
      <h1 className="text-3xl lg:text-5xl">there&apos;s a meaning in cleaning</h1>
      </div>
